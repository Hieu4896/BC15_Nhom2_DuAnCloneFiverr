  ...
  return (
    <div className={Style["footer"]}>
      <div className="dropdown">
        <button
          className=" text-left btn btn-success dropdown-toggle w-100"
          type="button"
      ...
      <div className="dropdown mt-2">
        ...
        <div className="dropdown-menu w-100" aria-labelledby="dropdown-About">
          <a className="dropdown-item" href="#">
            Careers
          </a>
          <a className="dropdown-item" href="#">
      ...
      <div className="dropdown mt-2">
        ...
        <div className="dropdown-menu w-100" aria-labelledby="dropdown-Support">
          <a className="dropdown-item" href="#">
            Help & Support
          </a>
          <a className="dropdown-item" href="#">
      ...
      <div className="dropdown mt-2">
        ...
        <div
          className="dropdown-menu w-100"
          aria-labelledby="dropdown-Community"
        >
          <a className="dropdown-item" href="#">
            Events
          </a>
      ...
      <div className="d-flex align-items-center flex-column justify-content-center mt-5 w-100">
        ...
        <p style={{ fontSize: 15 }}> © Fiverr International Ltd. 2021</p>

        <div>
          <ul className={Style["social-Platform"]}>
            <li>
